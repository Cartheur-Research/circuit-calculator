...
namespace Modeling_G
{
    ...
    public class CircuitCalculatorEngagementTests
    {
        ...
        /// </summary>
        /// <remarks>This is how the output of coding should appear. A reporting-style theme. This is the best strategy for analytics.</remarks>
        [TestMethod]
        ...
        /// <summary>
        /// The object-test-framework approach toward computational modeling.
        /// </summary>
        [TestMethod]
        public void ModelTests() 
        {
            // Create the transmitter and the receiver antenna objects.
            AntennaLegs = new[] { 20.0, 20.0, 50.0 };
            TxAntenna = Core.CreateAntenna(new Circuit(4.5, new Complex(1.105, 0), 90, "nF"), Antenna.AntennaPresence.Transmitter, AntennaLegs, 50, 1.2, 40);
            AntennaLegs = new[] { 20.0, 20.0 };
            RxAntenna = Core.CreateAntenna(new Circuit(4.5, new Complex(0.05, 0), 90, "nF"), Antenna.AntennaPresence.Receiver, AntennaLegs);
        ...
        /// <summary>
        /// The first experiment in the new publication push-drive.
        /// </summary>
        [TestMethod]
        public void QuestionMassOrNoMass()
        {
            // Create the transmitter and the receiver antenna objects.
            AntennaLegs = new[] { 20.0, 20.0, 50.0 };
            TxAntenna = Core.CreateAntenna(new Circuit(4.5, new Complex(1.105, 0), 90, "nF"), Antenna.AntennaPresence.Transmitter, AntennaLegs, 50, 1.2, 40);
